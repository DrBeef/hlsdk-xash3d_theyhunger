...
CWeaponEinarShovel g_Shovel;
CWeaponEinarSpanner g_Spanner;
CWeaponEinarAP9 g_AP9;
CWeaponEinarTaurus g_Taurus;
CWeaponEinarSniper g_HKG36;
CWeaponEinarTFCSniper g_Einar1;
CWeaponEinarChaingun g_Chaingun;
CWeaponEinarMedkit g_Medkit;
...
void HUD_WeaponsPostThink( local_state_s *from, local_state_s *to, usercmd_t *cmd, double time, unsigned int random_seed )
{
	...
	else if (player.m_pActiveItem->m_iId == WEAPON_SNIPER || player.m_pActiveItem->m_iId == WEAPON_TFCSNIPER)
	{
